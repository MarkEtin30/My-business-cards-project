...
function CardItem({ card }) {
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      console.log(isFavouriteInArray + " in array location");
      if (isFavouriteInArray >= 0) {
        console.log("set Fav okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk");
        setFavChange(true);
        setIsFavourite(true);
      }
    }
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      if (isFavourite === true) {
        ...
        console.log(cards[indexOfCurrentCard].Data.usersIdWhoFavourCardList);
      ...
      if (isFavourite === false) {
        console.log("falssssssssssseeeeeeeeeeee");
